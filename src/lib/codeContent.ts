...
export const CODE_SECTIONS: CodeSection[] = [
  ...
  },
  {
    ...
    points: [
      'Give the customer the opportunity to carry out a pre-completion inspection, or appoint a suitably qualified inspector, before the completion date and after notice to complete is served (or earlier if you and the customer both agree).',
  ...
  },
  {
    ...
    points: [
      ...
      'Provided the building regulation completion certificate if available; if not, told the customer it will not be available until after completion, or signposted the organisation that can provide it.',
    ],
...
export const QUICK_ANSWERS: { q: string; ref: string; a: string }[] = [
  ...
  { q: 'What must I hand over at completion?', ref: '2.11', a: 'Evidence the warranty is in place (2.10), both Schedules of Incomplete Work (Home 2.11, Development 2.12), the pre-completion inspection offer, a home demonstration appointment, warranty documents, complaints procedure copy, health & safety file, the building regulation completion certificate (or tell the customer it will not be available until after completion, or signpost who can provide it), and the inspection records if asked.' },
  ...
  { q: 'How much can I charge for early bird / plot reservation?', ref: '2.1', a: 'No more than £150, with clear refund terms (full refund if the customer tells you within 24 hours of being told the plot is being released, or a longer period you set).' },
  ...
  { q: 'What must be in the Reservation Agreement?', ref: '2.2', a: 'Who they are buying from, the fee, the 14-day cooling-off, refund terms, the home’s details and price, warranty contact and summary, the exchange-by date (reasonable in the circumstances, and not less than six weeks after reservation unless the customer asks for earlier), tenure and costs — plus the Affordability Schedule.' },
  ...
  { q: 'How much notice of completion must I give?', ref: '2.8', a: 'The completion notice period is usually expected to be at least 14 calendar days unless you and the customer agree otherwise, so there is time for the pre-completion inspection after notice is served.' },
]
