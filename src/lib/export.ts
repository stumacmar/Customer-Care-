...
<html><head><meta charset="utf-8"><title>Compliance record — ${escapeHtml(plot.address)}</title>
<style>
...
<body>
  ...
  <div class="foot">This record was generated by Plot Clock (NHQB Code Compliance Tracker). Timeline events are recorded at the time each action was taken.</div>
</body></html>`)
  win.document.close()
  win.focus()
}
